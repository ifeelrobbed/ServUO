...
namespace Server
{
	...
	public class SkillInfo
	{
        ...
        private static SkillInfo[] m_Table = new SkillInfo[58]
		{
			...
			new SkillInfo(15, "Discordance", 0.0, 2.5, 2.5, "Demoralizer", null, 0.0, 0.25, 0.25, 1.2, StatCode.Dex, StatCode.Int, true ),
			...
			new SkillInfo(26, "Resisting Spells", 0.0, 0.0, 0.0, "Warder", null, 0.25, 0.25, 0.5, 1.4, StatCode.Str, StatCode.Dex),
