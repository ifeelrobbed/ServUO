...
namespace Server.Items
{
    ...
    public class Corpse : Container, ICarvable
    {
        ...
        private static readonly TimeSpan m_DefaultDecayTime = TimeSpan.FromMinutes(8.0); // default 7.0
        private static readonly TimeSpan m_BoneDecayTime = TimeSpan.FromMinutes(8.0); // default 7.0
